...
switch input
    ...
    case{2} % Configuration 2, Right Expansion and left strong shock
        fprintf('Case 2: Right Expansion and left strong shock \n');
        p   = [7    10   ];
        u   = [0    0    ];
        rho = [1    1    ];
        tEnd = 0.1; cfl = 0.90;
        
    case{3} % Configuration 3, Double Shock
        fprintf('Case 3: Double Shock \n');
        p   = [450  45   ];
        u   = [20   -6   ];
        rho = [6    6    ];
        tEnd = 0.02; cfl = 0.90;
        
    case{4} % Configuration 4, Double Expansion
        fprintf('Case 4: Double Expansion \n');
        p   = [40   40   ];
        u   = [-2   2    ];
        rho = [1    2.5  ];
        tEnd = 0.03; cfl = 0.90;

    case{5} % Configuration 5, Cavitation
        fprintf('Case 5 Cavitation \n');
        p   = [0.4  0.4  ];
        u   = [-2    2   ];
        rho = [ 1    1   ];
        tEnd = 0.1; cfl = 0.90;
        
	case{6} % Configuration 6, Left Expansion and right strong shock
        fprintf('Case 6: Left Expansion and right strong shock \n');
        p   = [1000 0.1  ];
        u   = [0    0    ];
        rho = [3    2    ];
        tEnd = 0.02; cfl = 0.90;
